...
class EndpointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create a new endpoint with valid params" do
    post endpoints_path, params: { data: { type: 'endpoints', attributes: { verb: 'GET', path: '/bonjour', response: { code: 201, body: { message: 'Bonjour'}}}}}, as: :json
    assert_response :created
    assert_not_nil Endpoint.find_by_path('/bonjour')
  end

  test "should not save endpoint with invalid verb(GETA)" do
    post endpoints_path, params: { data: { type: 'endpoints', attributes: { verb: 'GETA', path: '/bye', response: { code: 201, body: { message: 'Bonjour'}}}}}, as: :json
  ...
  test "should update the endpoint" do
    ...
    patch endpoint_path(Endpoint.last), params: { data: { type: 'endpoints', attributes: { verb: 'GET', path: '/new-path', response: { code: 201, body: { message: 'Hola'}}}}}, as: :json
    end
    assert_response :ok
